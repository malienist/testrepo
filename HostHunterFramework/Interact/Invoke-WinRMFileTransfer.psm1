function Invoke-WinRMFileTransfer{
	<#
	.Synopsis
	...
	Out-Splunk -IP $SplunkIP -Port $AccountabilityPort -Object $CommandObject

	$file = $LocalFilePath
	$content = [System.IO.File]::ReadAllBytes($file)
	$filetransfer = Invoke-Command -ComputerName $Target -Credential $cred -Scriptblock{
	...
	Out-Splunk -IP $SplunkIP -Port $SplunkPort -Object $filetransfer
